...
async function getStartManifest() {
  const { tsrStartManifest } = await import('../_/_tanstack-start-manifest_v-DyaPLcp4.mjs');
...
var manifest = {
  "a71b2d242e677da21a9b49fc012bb4897134df5c876d0db5c49429e623ce605e": {
    functionName: "getAppwriteSessionFn_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
  "15f08b3d6d132e0e3e7a191a76aec017928e1e6319c39b50ebea162e8a542822": {
    functionName: "setAppwriteSessionCookiesFn_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
  "8d08449bae12e9488f534f836f3792ed5da6a42e92cff6580e2a6751b6a136ad": {
    functionName: "signUpFn_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
  "b076cb75c3e5b346087aaca55fd05f552ee647e26fe91888fcf9d4c17d47939f": {
    functionName: "signInFn_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
  "c87d01763c380aa6e92391027d4c543d8ec65158be93bb184a4a116702451815": {
    functionName: "signOutFn_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
  "224e3725f631022542b50386b57b0c4e501810608d50bc677a2e5448a3b823db": {
    functionName: "authMiddleware_createServerFn_handler",
    importer: () => import('../_/auth-B1u2jsgB.mjs')
  },
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) routerEntry = await import('../_/router-Dneg7yWn.mjs').then(function (n) { return n.r; });
    if (startEntry === null) startEntry = await import('../_/start-BK7H0vun.mjs');
    return {
      startEntry,
      routerEntry
    };
...
export { TSS_SERVER_FUNCTION as T, createServerFn as a, setResponseStatus as b, createServerRpc as c, deleteCookie$1 as d, getServerFnById as e, entry$1 as f, getCookie as g, setCookie$1 as s };
