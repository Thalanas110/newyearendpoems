...
export const poems: Poem[] = [
  ...
  {
    // poem 10
    id: 'a-prayer-for-my-family',
    title: 'A Prayer for My Family',
    whois: ['Grandma', 'Grandpa', 'tita'],
    author: 'Francis Lawrence P. Morales',
    password: 'danilofelia',
    moods: ['grateful', 'reflective', 'hopeful'],
    stanzas: [
      [
        'Lord, I lift my grandparents up to You,',
        'For every lesson, every care, every breakthrough.',
        'For Grandma, who shaped me with love and might,',
        'Through math, swimming, meals, and every fight.',
      ],
      [
        'Bless her for patience, for guiding my hand,',
        'For cheering me on as I learned to stand.',
        'For every stage, every award, every cheer,',
        'For holding my heart when I was unclear.',
      ],
      [
        'Bless her for care through illness and pain,',
        'For tending to me again and again.',
        'For love that never wavered, even when I fought,',
        'For every sacrifice silently taught.',
      ],
      [
        'Bless Grandpa for hands that rescued me,',
        'From sketchy corners, from uncertainty.',
        'For work done long after strength should fail,',
        'For quiet guidance that always set sail.',
      ],
      [
        'Bless him for Chuk, for laughter, for play,',
        'For love expressed in every small way.',
        'For patience with Grandma, with every headache caused,',
        'For life shaped in action, never paused.',
      ],
      [
        'Bless him for faith, for saving hearts afar,',
        'For guiding the Aetas with grace like a star.',
        'For church, for service, for devotion true,',
        'For teaching me what steadfast love can do.',
      ],
      [
        'Bless Aunt for fiery love, for every fight,',
        'Yet always a heart open, always right.',
        'For biscuits, for chocolate, for red-day care,',
        'For showing love in ways uniquely rare.',
      ],
      [
        'Bless her for lessons, for presence, for fun,',
        'For holding me close even when I would run.',
        'For guidance that balanced sternness and grace,',
        'For shaping my heart in her quiet embrace.',
      ],
      [
        'Bless the family as a whole, near and far,',
        'For every struggle, every guiding star.',
        'For unity, for laughter, for countless small deeds,',
        'For filling our lives with love that exceeds.',
      ],
      [
        'Bless them for patience when tempers flare,',
        'For understanding when life felt unfair.',
        'For wisdom passed down in word and in act,',
        'For building a home of love that\'s exact.',
      ],
      [
        'Bless them for sacrifices, silent and true,',
        'For putting our needs before their own view.',
        'For laughter, for meals, for guidance, for care,',
        'For always being present, always there.',
      ],
      [
        'Bless them for teaching me resilience and fight,',
        'For showing me wrong from right.',
        'For every argument that ended in love,',
        'For the push and the pull, the care from above.',
      ],
      [
        'Bless them for their faith, in church and in life,',
        'For giving light through hardship and strife.',
        'For modeling courage in all that they do,',
        'For giving me roots and wings too.',
      ],
      [
        'Bless them for joy, for smiles, for song,',
        'For reminding me where I belong.',
        'For memories shaped with warmth and delight,',
        'For comfort and love in day and night.',
      ],
      [
        'Bless them for guidance that never ends,',
        'For patience that teaches, for being my friends.',
        'For every hand reached in help or embrace,',
        'For every smile that brightens the place.',
      ],
      [
        'Bless them for courage in all that they face,',
        'For working, for serving, for holding their space.',
        'For care that is constant, though words may be few,',
        'For a legacy of love that always rings true.',
      ],
      [
        'Bless them for blessings too many to count,',
        'For every act that amounts to mount.',
        'For shaping a family, for love interwoven,',
        'For hearts that are steadfast, hearts that are proven.',
      ],
      [
        'Lord, let them feel peace, joy, and rest,',
        'Let laughter and love fill each chest.',
        'For my grandparents, aunt, and family dear,',
        'May Your grace surround them year after year.',
      ],
      [
        'Bless them in health, in hope, in delight,',
        'Keep their hearts warm through every night.',
        'For all they have done, and all they will do,',
        'I lift them in prayer, faithful and true.',
      ],
    ],
  },
  { // poem 11
    id: 'a-birthday-wish-for-grandpa',
    title: "A Birthday Wish for Grandpa",
    whois: ['Grandpa'],
    author: 'Francis Lawrence P. Morales',
    password: '123155',
    ...
    stanzas: [
      [
        'Another year shines bright for you today,',
        'May laughter and love light every way.',
        'For all you’ve done, for all you give,',
        'We celebrate your life, the way you live.',
      ],
      [
        'Hands that guided, strong and true,',
        'A heart that’s patient in all you do.',
        'From every rescue to every smile,',
        'You make each moment so worthwhile.',
      ],
      [
        'So here’s to joy, to health, to cheer,',
        'To memories made and another year.',
        'Happy Birthday, Grandpa, with love so deep,',
        'May blessings surround you, and laughter keep.',
      ],
    ],
  },
  { // poem 12
